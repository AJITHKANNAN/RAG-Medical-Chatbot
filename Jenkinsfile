        ...
        stage('Clone GitHub Repo') {
            steps {
                script {
                    ...
                    checkout scmGit(branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: 'git_jenkins_token', url: 'https://github.com/AJITHKANNAN/RAG-Medical-Chatbot.git']])
                }
            }
        }
